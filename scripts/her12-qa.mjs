...
for(const ref of ['styles-v2.css','enhancements-v3.css','experience-v4.css','experience-v5.css','experience-v6.css','experience-v7.css','experience-v8.css','experience-v9.css','program-v2.js','runtime-v2.js','enhancements-v3.js','experience-v4b.js','experience-v5.js','experience-v6.js','experience-v7.js','experience-v8.js','experience-v9.js','manifest.webmanifest','apple-touch-icon.png'])if(!index.includes(ref))fail(`index.html does not reference ${ref}`);
...
for(const [name,source] of [['runtime-v2.js',runtime],['enhancements-v3.js',enhancements],['experience-v4b.js',v4],['experience-v5.js',v5],['experience-v6.js',v6],['experience-v7.js',v7],['experience-v8.js',v8],['experience-v9.js',v9]]){try{new vm.Script(source)}catch(error){fail(`${name} syntax error: ${error.message}`)}}
...
for(const ref of ['./enhancements-v3.css','./enhancements-v3.js','./experience-v4.css','./experience-v4b.js','./experience-v5.css','./experience-v5.js','./experience-v6.css','./experience-v6.js','./experience-v7.css','./experience-v7.js','./experience-v8.css','./experience-v8.js','./experience-v9.css','./experience-v9.js','WARM_MEDIA','her12-v12'])if(!sw.includes(ref))fail(`service worker missing current cache primitive: ${ref}`);

if(!process.exitCode)console.log(`HER12 QA OK: ${sessions.length} sessions, ${ids.size} unique exercises, ${media.size} local images, glute planning ${gluteVolume.map(v=>v.toFixed(2)).join(' -> ')} effective-set estimate, triceps ${tricepsVolume.join(' -> ')}, loaded abs ${abs.sets.join(' -> ')}, v9 quiet single-lane flow verified.`);
